"""
This script is called by the plugin-wrapper, extractdata.js, which passes down the
...
plugin = extractdata(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
