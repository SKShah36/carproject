"""
This script is called by the plugin-wrapper, CostCalculator.js, which passes down the
...
plugin = CostCalculator(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
